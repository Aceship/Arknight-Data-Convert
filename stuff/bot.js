...
let activityTable = JSON.parse(fs.readFileSync(exceldir+"activity_table.json","utf8"))

activityTable.missionData.forEach(element => {
    if(element.rewards.find(search=>search.id=="act4d5_point_kfc")){
